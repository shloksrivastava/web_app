...
if(isset($_POST['father'])){
	...
	$sql = "INSERT INTO surveydata (email,father,course,sem,address1,address2,country,state,zip,mobile,fmobile,femail,cgpa,per) VALUES('$email','$father','$course','$sem','$address1','$address2','$country','$state','$zip','$mobile','$fmobile','$femail','$cgpa','$per')";
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  ...
  <div class="py-5 text-center">
    ...
    <p class="lead">Hello <?php echo $_SESSION['username']; ?>.Below is a form built for students to express their views on some of the questions.After finishing the form you can logout <a href="logout.php">here</a>.</p>
  </div>
