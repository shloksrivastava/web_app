...
if(isset($_POST['name'])){
	...
	$enroll = $_POST['enroll'];
	$sql = "INSERT INTO users(name,email,enroll,password) VALUES('$name','$email',$enroll,'$password')";
...
<header>
	...
	<div class="container">
		...
		<nav class="py-3 d-lg-flex">
			<div id="logo">
				<h1 > <a href="index.html"><img src="images/s2.png" alt=""><span class=""> Jaypee Institute of Information Technology, Noida </span></a></h1>
			</div>
						...
						<div class="padding">
							...
							<form action="" method="post">
								...
								<div class="form-style-w3ls">
									...
									<input placeholder="Enrollment Number" name="enroll" type="text" required="">
		...
		<div class="container py-md-3">
			<div class="footer-grid_section text-center">
				<div class="footer-title mb-3">
					<a href="#"><img src="images/s2.png" alt=""> JAYPEE INSTITUTE OF INFORMATION TECHNOLOGY, NOIDA </a>
				</div>
	...
	<div class="container py-4">
		<div class="row bottom">
			...
			<div class="text-center">
				<p class="">© 2019 JIIT, NOIDA. All rights reserved | Design by
					<a href="#"> Shlok Srivastava</a>
				</p>
			</div>
		</div>
	</div>
