...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  ...
  <div class="py-5 text-center">
    ...
    <p class="lead">Hello <?php echo $_SESSION['username']; ?>.Below is a form previously submitted by you. You can click the 'Edit' button to edit your entries or you can logout <a href="logout.php">here</a>.</p>
  </div>
