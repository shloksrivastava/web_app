...
<header>
	...
	<div class="container">
		...
		<nav class="py-3 d-lg-flex">
			<div id="logo">
				<a href="index.php"><img src="images/s2.png" alt=""> Jaypee Institute of Information Technology, Noida</a>
                        </div>
							...
							<li>
								<div class="container-fluid">
									<div class="w3ls_banner_txt">
										<h3 class="b-w3ltxt text-capitalize mt-md-4">Study For Better Future</h3>
		...
		<div class="container py-md-3">
			<div class="footer-grid_section text-center">
				<div class="footer-title mb-3">
					<a href="#"><img src="images/s2.png" alt="" style="border-radius: 10%;width: 80px;height: 80px;"> JAYPEE INSTITUTE OF INFORMATION TECHNOLOGY, NOIDA </a>
				</div>
